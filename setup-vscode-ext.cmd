@echo off
:: Build and install the codesearch VS Code extension.
:: Run this after setup_mcp.cmd, or standalone to reinstall/update the extension.
::
:: Requires: VS Code (code on PATH), Node.js 20+ (auto-installed via winget if missing)

setlocal
pushd "%~dp0vscode-codesearch"
...
echo.
echo Done! Reload VS Code and open "TsCodeSearch: Open Panel" with Ctrl+Shift+F1.
goto :eof
