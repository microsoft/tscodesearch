...
_CS_FILE = os.path.join(_SAMPLE, "DataStore.cs")
_PY_FILE = os.path.join(_SAMPLE, "pipeline.py")
...
class TestGetRoot(unittest.TestCase):
    ...
    def test_dict_entry_uses_external_path(self):
        _ms._ROOTS["complex"] = {"external_path": "C:/complex/src", "other": "ignored"}
