...
_SAMPLE = REPO_ROOT / "sample" / "root1"
FIXTURE_PATH      = str(_SAMPLE / "query_fixture.cpp")
HAL_FIXTURE_PATH  = str(_SAMPLE / "cpp" / "hal_fixture.h")
CORNER_CASES_PATH = str(_SAMPLE / "cpp" / "corner_cases.h")
