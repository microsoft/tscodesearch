...
Integration tests (require Typesense) are in tests/integration/test_mode_callers.py.

Run (no Typesense):
    pytest tests/unit/test_mode_callers.py -v
"""
...
from tests.fixtures import (
    CALLS_FETCHWIDGET, DEFINES_FETCHWIDGET,
