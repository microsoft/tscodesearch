...
Run (no Typesense):
    pytest tests/test_api_dispatch_tables.py -v
"""
...
_indexserver = os.path.join(_root, "indexserver")
for p in (_root, _indexserver):
    if p not in sys.path:
        sys.path.insert(0, p)

from indexserver.api import _EXT_TO_TS_AND_AST, _run_query
